...
export MODEL_NAME="logs/VG_run_regularizer_{lg}_steps_{1k}_lr_{5e-4}_lambda_10_cosine_lora"
export RUN_NAME="VG_run_regularizer_{lg}_steps_{1k}_lr_{5e-4}_lambda_10_cosine_lora"
