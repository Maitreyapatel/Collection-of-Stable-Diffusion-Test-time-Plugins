...
export MODEL_NAME="logs/VG_run_regularizer_{lg}_steps_{10k}_lr_{5e-4}_lambda_5_cosine_lora"
export RUN_NAME="VG_run_regularizer_{lg}_steps_{10k}_lr_{5e-4}_lambda_5_cosine_lora"
