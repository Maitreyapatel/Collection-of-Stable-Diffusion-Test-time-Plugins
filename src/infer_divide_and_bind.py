...
from src.pipeline_divide_and_bind import DivideAndBindPipeline
...
def load_model(config):
    ...
    stable = DivideAndBindPipeline.from_pretrained(stable_diffusion_version).to(device)
    return stable
...
def run_on_prompt(
    ...
    outputs = model(
        ...
        bind_tokens=config.bind_tokens,
