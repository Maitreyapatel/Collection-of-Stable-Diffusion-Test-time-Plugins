...
# for layout-guidance
python main.py --exp_name=lg --lg.seeds=[42,52,101] --lg.prompt="an apple to the right of the dog." --lg.phrases="dog;apple" --lg.bounding_box="[[[0.1, 0.2, 0.5, 0.8]],[[0.75, 0.6, 0.95, 0.8]]]"
```

## Currently supported tasks:
* Attend-and-Excite ("aae") -- only inference
* Layout-Guidance ("lg") -- only inference
